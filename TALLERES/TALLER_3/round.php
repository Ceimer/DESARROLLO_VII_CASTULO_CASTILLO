...
function redondearPrecio($precio) {
    return round($precio * 20) / 20; // Redondea al múltiplo más cercano de 0.05
}
...
function redondeoPersonalizado($numero, $incremento = 0.5) {
    return round($numero / $incremento) * $incremento; // Redondea al múltiplo más cercano del incremento dado
}
